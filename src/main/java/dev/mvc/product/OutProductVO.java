...
public class OutProductVO {
  ...
  String product_name, product_img, material, product_introimg, product_target, product_weight, product_rdate, product_udate, category_title, country_name, manufacturer_name, manufacturer_img;
  char product_visible;
  double product_wprotein, product_wfat, product_wash, product_wfiber, product_wcalcium, product_wp;
  
  public OutProductVO() {
  }

  public OutProductVO(int product_no, int manufacturer_no, int country_no, int category_no, int product_price,
      ...
      String category_title, String country_name, String manufacturer_name, String manufacturer_img,
      char product_visible, double product_wprotein, double product_wfat, double product_wash, double product_wfiber,
    ...
    this.product_wprotein = product_wprotein;
  ...
  public double getProduct_wprotein() {
    return product_wprotein;
  }

  public void setProduct_wprotein(double product_wprotein) {
    this.product_wprotein = product_wprotein;
  }
