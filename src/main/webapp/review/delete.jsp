    ...
    <FORM name='frm' method='POST' action='./delete.do'>
      ...
      <input type="" name="nowPage" value="${param.nowPage }">
		...
		<section id="error-page" class="fixed-no-header">
          ...
          <span class="title" style="font-size:30px; font-weight:bold; ">"${reviewVO.review_title }"</span>
						<h2 class="line-broken">삭제하시겠습니까? </h2>
            <div class="text">
              삭제하시면 복구 할 수 없습니다.
            </div>
						<a href="./list.do?category_no=${categoryVO.category_no}" class="btn btn-default error-button">목록으로</a>
						<button type="submit"  class="btn btn-default error-button">삭제</button>
					</div>
				</div>
			</div>
		</section>
