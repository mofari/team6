      ...
      <div class="container">
        <div class="row">
            ...
            <div class="info-block" id="basic" >
              ...
              <div class="row">
                ...
                <div style="font-size: 13px; margin-bottom: 6px; color: #1fb7a6;">리뷰 제목</div>
                  <input id="review_title" class="form-control" type="text" value="${review_memberVO.review_title}" placeholder="제목을 입력해주세요" name="review_title"  required>
                </div>  
                </div>
                <div class="row">
              <div class="col-md-12"  style="margin-top: 30px;">
                  <div class="ui-widget">
                      ...
                      <input id="product_name" class="form-control" type="text" value="${productVO.product_name}"  placeholder="'어'를 입력해보세요" name="product_name" onkeyup="javascipt:product_name_search();" required>
                        <div class="col-md-12">
                          <TABLE>
              ...
              <div class="col-md-5"  style="margin-top: 30px;">
                <div style="font-size: 13px; margin-bottom: 6px; color: #1fb7a6;">별점</div>
                  <input id="review_grade" class="form-control" type="number" name="review_grade"  value="${review_memberVO.review_grade }" max='5' min='1' required>
              </div>
              </div>
            </div>
            ...
            <div class="info-block" id="summary">
              ...
              <div class="row">
                ...
                <div style="font-size: 13px; margin-bottom: 6px; color: #1fb7a6;">내용</div>
                  <textarea name='review_content'  id='review_content' rows='10' cols='70' >${review_memberVO.review_content }</textarea>
                </div>
            </div>
          ...
          <div class="col-sm-12 col-md-8 text-right" style="margin-top: 30px;">
            <button class="btn btn-default signin-button" type="submit"><i class="fa fa-sign-in"></i> 수정</button>
          </div>
        </div>
