...
<script type="text/JavaScript">
  ...
  <jsp:include page="/menu/top2.jsp" flush='false' />
	...
	<div id="page-container">
      ...
      <input type='hidden' name='pet_no' id='pet_no' value='1'>  
    ...
    <div class= "row" >
        ...
        <label for="diary_title" class="col-md-1 control-label" style=""></label>
        <div class="col-md-11" style="margin-top : 20px; width:95%;">
          <input type='text' class="form-control input-lg" name='diary_title' id='diary_title' value=''  placeholder="제목" required="required" style='width: 100%;'>
        </div>
        
        <label for="content" class="col-md-1 control-label"></label>
        <div class="col-md-11"  style="margin-top : 20px; width:95%;">
          <input type='text' class="form-control input-lg" name='diary_place' id='diary_place' value='' placeholder="장소">
        </div>
      ...
      <div class="form-group">   
        <label for="content" class="col-md-1 control-label"></label>
        <div class="col-md-11"  style="margin-top : 20px; width:95%;">
          <textarea class="form-control input-lg" name='diary_content' id='diary_content'  rows='10' ></textarea>
      ...
      <div class="form-group">   
        <label for="filesMF" class="col-md-1 control-label" style="marigin:0px;"></label>
        <div class="col-md-11" style="width:95%;">
          <input type="file" class="form-control input-lg"  id='file1MF' name='file1MF'  size='40' >
          <br>
