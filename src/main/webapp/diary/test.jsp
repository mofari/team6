 ...
 <link rel="stylesheet" href="/review/resources/css/vendor/flipclock/flipclock.css">               <!-- Flip Countdown -->
  ...
  <c:import url="/menu/top2.jsp" />
    ...
    <div style="float:right; margin-right:60px;"><A href='./create.do?category_no=${param.category_no }'>등록</A></div>
			<div class="container">
      <form name="frm" id="frm" action="./list_paging.do">
      ...
      <c:forEach var="diaryVO" items="${list }">
               ...
               <a class="hover-effect image image-fill" href="./read.do?diary_no=${diaryVO.diary_no}&category_no=${diaryVO.category_no}">
                ...
                <c:choose>
                  <c:when test="${diaryVO.diary_thumb != ''}">
                            <img alt="thumb" id='thumb'  src='./storage/${diaryVO.diary_file }'>
                          </c:when>
                  <c:otherwise>
                    <!-- 파일이 존재하지 않는 경우 -->
               ...
               <a href="./read.do?diary_no=${diaryVO.diary_no}&category_no=${diaryVO.category_no}">
                <c:choose>
                  <c:when test="${fn:length(diaryVO.review_title) > 12}">
              ...
              <span class="event_good" >
                <img src='./images/good.png' style="width: 8%; margin-right: 3px;">${diaryVO.review_good }
                <img src='./images/reply.png' style="width: 8%; margin-right: 3px; margin-left:8px;">${diaryVO.review_reply_cnt }
              </span>
