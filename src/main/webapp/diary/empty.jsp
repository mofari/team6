...
<div class="skyline">
        ...
        <div class="container header-text">
          <div><h1 class="title">${categoryVO.category_title } ���̾</h1></div>
          <div><h2 class="sub-title">�ڽ��� �ֿϵ����� �ڶ��غ��ƿ�~</h2></div>
        </div>
      </div>
  <div id="breadcrumb">
				<div class="container">
      ...
      <div class="container">
        <div class="row">
          ...
          <input type='text'   class ="margin form-control" name='word' id='word' value='' style='width: 35%;'>
           <button  class = "btn btn-default signin-button" type='submit'><i class="fa fa-pinterest-p">�˻�</i></button>
               <c:if test="${param.word.length() > 0}"> 
      
      [${param.word}] �˻� ���(${search_count } ��) 
      <button class="btn btn-default "  type="button"
    onclick="location.href='./list_paging.do?category_no=${param.category_no}'" >    
        <i class="fa fa-sign-in"></i>���</button>
    </c:if>
           </div>
          <c:forEach var="diaryVO" items="${list }">   <!--  VO �����ͼ� ����Ʈ�� ����? -->
            ...
            <div class="row blog-list" style="border:5px solid #E5E5E5;">
              ...
              <div class="col-md-7">
                <%-- <h2 class="subtitle"><a href="blog-detail.html">${diaryVO.diary_title }</a></h2> --%>
                 <h3 class="subtitle"  style="margin-top:20px;">���� : ${diaryVO.diary_title }</h3><br>
                <h2 class="title" >�ۼ��� : ${diaryVO.member_nickname }</h2>
                <h2 class="title" >����� : ${diaryVO.diary_rdate.substring(0, 10) } ${diaryVO.category_no }</h2>
              ...
              <a href="./update.do?diary_no=${diaryVO.diary_no}&category_no=${diaryVO.category_no}&nowPage=${param.nowPage}"><img src="./images/update.png" title="����" border='0'/></a>
              <a href="./delete.do?diary_no=${diaryVO.diary_no}&category_no=${diaryVO.category_no}&nowPage=${param.nowPage}"><img src="./images/delete.png" title="����"  border='0'/></a>
              </div>
             </div> 
