...
<html lang="ko">
  ...
  window.onload=function(){
    like(${eventVO.member_no});
  }
  
    function like(member_no){
      var like_check = ${like_check};
   		if(like_check==1){		// 좋아요
   		 document.bfgood.src="./images/afgood.png";
   		  like_check=0;
   		} else {	// None
   		 document.bfgood.src="./images/bfgood.png";
   		  like_check=1;
   		}
     } 
    ...
    function like_change(member_no, like_check){
      $.ajax({
         ...
         data: 'event_no=' +${param.event_no},
         // Ajax 통신 성공, JSP 정상 처리 
         success: function(rdata) { // callback 함수
           var good_cnt = rdata.good_cnt;
      ...
      <input type="hidden" id="like_check" name="like_check" value="${like_check }">
       <div class="event_read_header" > 
             ...
             <div class="event_read_headr_title" style="position: relative;">
              ...
              <img alt="good images" src='./images/good.png'  name="bfgood"  id="bfgood" style="width: 30px;" onclick="like_change(${eventVO.member_no},${like_check })">
              </div>
              <%-- <div class="good_cnt" style="text-align:center; margin-right:7%;" id="good_cnt" >${good_cnt }</div> --%>
