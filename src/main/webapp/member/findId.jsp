					...
					<div class="col-sm-5 col-sm-pull-7 col-md-4 col-md-pull-8">
						<div class="box">
							<h2 class="title">아이디 찾기</h2>
                              ...
                              <div class="field">                             
                            <input type='text'  class="form-control"  name='member_name' id='member_name'  required="required" autofocus="autofocus" placeholder="유저 이름" >
                          ...
                          <div class="field">
                         <input type='text' class="form-control" name='member_tel' id='member_tel'  required="required" placeholder="전화번호" >
                         <i class="fa fa-ellipsis-h"></i>
							...
							<div class="field footer-form text-right">
								<button type="submit" class="btn btn-default button-form">아이디 찾기</button>
							</div>
						</div>
					</div>
				</div>
