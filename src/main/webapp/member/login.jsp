...
<script type="text/javascript" src="../js/naveridlogin_js_sdk_2.0.0.js"></script>
					...
					<div class="col-sm-5 col-sm-pull-7 col-md-4 col-md-pull-8">
						<div class="box">
							<h2 class="title">Login</h2>
                              ...
                              <div class="field">                             
                            <input type='text'  class="form-control"  name='member_email' id='member_email' value='${ck_id }' required="required" autofocus="autofocus" placeholder="Email" >
                            <i class="fa fa-user user"></i>
                                </div>
                            <Label>   
                              <input type='checkbox' name='id_save' value='Y' 
                               ${ck_id_save == 'Y' ? "checked='checked'" : "" }> save
                            </Label>
                        
                            
                          <div class="field">
                         <input type='password' class="form-control" name='member_passwd' id='member_passwd' value='${ck_passwd }' required="required" placeholder="Password" >
                         <i class="fa fa-ellipsis-h"></i>
                         </div>
                        <Label>
                          <input type='checkbox' name='passwd_save' value='Y' 
                                  ${ck_passwd_save == 'Y' ? "checked='checked'" : "" }> save
                       </Label>
  ...
  <!-- <script type="text/javascript">
    var naver_id_login = new naver_id_login("8IttUtHKvwHixky2a2P4", "http://localhost:9090/review/member/naver_create.jsp");
    var state = naver_id_login.getUniqState();
    naver_id_login.setButton("white", 2,40);
    naver_id_login.setDomain("http://localhost:9090/review/member/login.do");
...
<div id="naverIdLogin"><a id="naverIdLogin_loginButton" href="#" role="button"><img src="https://static.nid.naver.com/oauth/big_g.PNG" width=200></a></div>
<!-- <script> 

var naverLogin = new naver.LoginWithNaverId( 
{ 
clientId: "8IttUtHKvwHixky2a2P4",
callbackUrl: "http://localhost:9090/review/member/callback.do", 
isPopup: false, 
