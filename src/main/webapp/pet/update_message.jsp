    ...
    <UL>
      <c:choose>
        <c:when test="${param.count == 0}">
          <li class='list-group-item'>펫 수정에 실패했습니다.</li>
        ...
        <c:when test="${param.count == 1 }">
          <li class='list-group-item'>펫 수정에 성공했습니다.</li>
          <li class='list-group-item'>
            <br>
            <button type='button'  class="btn btn-default button-form"  onclick="location.href='./read.do?pet_no=${param.pet_no}'">수정 확인</button>
