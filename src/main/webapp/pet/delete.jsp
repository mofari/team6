...
<jsp:include page="/menu/top.jsp" flush='false' />
 ...
 <div id="page-container">
  ...
  <span><i class="icon fa fa-plus-square"></i>반려동물 삭제</span>

<DIV class='content' style='width: 500px; text-align: center;'>
  <FORM name='frm' method='POST' action='./delete.do'>
    '${petVO.pet_name }(${petVO.pet_gender })' 삭제하면 복구 할 수 없습니다.<br><br>
    정말로 삭제하시겠습니까?<br><br>         
    <input type='hidden' name='pet_no' value='${petVO.pet_no }'>     
