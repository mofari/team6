    ...
    <c:import url="/menu/top.jsp" />
		...
		<section id="header-page" class="header-margin-base">
			<div class="skyline">
				...
				<div class="container header-text">
					<div><h1 class="title">펫 등록</h1></div>
		...
		<section id="signin-page">
            ...
            <div id="sign-in" class="box">
              <h2 class="title">펫 등록</h2>
              <div class="form-inline">
                <div class="form-group">
                  <input type='text' class="form-control input-inline margin-right" name='pet_name' id='pet_name' 
                   required="required" placeholder="펫 이름">
                  <i class="fa fa-user user"></i>
                </div>
                </div>
                
            <div class="form-group">   
        <label for="filesMF" class="col-md-1 control-label">이미지 파일</label>
        <div class="col-md-11">
          ...
          <br>
                 ...
                 <div class="form-group">
                  <input type='number'   required="required" class="form-control" name='pet_age' id='pet_age' placeholder="나이" >
                  <i class="fa fa-ellipsis-h"></i>       
                </div>
              
              <div class="form-group">
                  <input type='number'   required="required" class="form-control" name='pet_weight' id='pet_weight' placeholder="몸무게" >
                  <i class="fa fa-ellipsis-h"></i>       
                </div>
              ...
              <div class="form-group">
                  ...
                  <input type = "radio" id= "pet_gender" name = "pet_gender" value = "수컷" checked = "checked"> 수컷    
                  <input type = "radio" id= "pet_gender" name = "pet_gender" value = "암컷"> 암컷<br>
             </div>
              
              <div class="field">
              <input type='text'  required="required"  class="form-control input-md" name='pet_kind' id='pet_kind' 
                  required="required" placeholder="종류">
                <i class="fa fa-ellipsis-h"></i>
              </div>
 
              <div class="field">
                <input id="pet_specific" required="required"  class="form-control" type="text" name="pet_specific" placeholder="특이사항" size='100'>
                <i class="fa fa-ellipsis-h"></i>
              </div>
              ...
              <div class="field footer-form text-right">
                <button type="submit" class="btn btn-default button-form">등록</button>
