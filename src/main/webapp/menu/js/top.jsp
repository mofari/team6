...
<header class="menu-dual-line" id="header-container-box">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              ...
              <a class="hidden-xs" href="call:1-800-555-1234"><i class="icon fa fa-phone"></i> (010)-1234-5678</a>
      ...
      <div class="container hidden-xs" id="menu-nav">
        <div class="logo">
          <a href="${pageContext.request.contextPath}/index.jsp"><img id="logo-header" src="${pageContext.request.contextPath}/resources/images/logo-lovepet3.png" alt="Logo" /></a>
        </div><!-- /.logo -->
        <nav id="navigation">
          <ul>
