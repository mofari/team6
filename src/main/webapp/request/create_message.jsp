      ...
      <div id="breadcrumb">
        <div class="container">
          <ol class="breadcrumb">
            ...
            <li><a href="#">이벤트</a></li>
            <li class="active">이벤트 신청</li>
            <li class="active">이벤트 신청 확인</li>
          </ol>
        </div>
      </div><!-- /#breadcrumb -->
      <span class="cover"></span>
              ...
              <DIV class='message' style='text-align: center;'> 
                    <c:choose>
                      <c:when test="${param.count == 1 }">
                        ...
                        <div style="margin-top: 30px; font-weight: 600;">이벤트 신청 되었습니다.</div>
                      </c:when>
                      <c:otherwise>
                          <img src="./images/fail.png" style="width: 10%;">
                        <div style="margin-top: 30px; font-weight: 600;">이벤트 신청 실패 하였습니다. 다시한번 시도하여 주십시오.</div>
                      </c:otherwise>
                    </c:choose>

                      <br>
                      <button type='button' onclick="location.href='${pageContext.request.contextPath}/event/list_event_paging.do'" class="btn btn-default select-button">목록</button>
              </DIV>
          </div>
        </div>
      </div>
