         ...
         <FORM name='frm' method='POST' action='./delete.do'>
              ...
              <div class="form-group">   
                <div class="col-md-12" style='text-align: center;padding-left: 20%;padding-right: 20%;'>
                  신청자: <b style="font-weight: 600;">${requestVO.event_requestman }</b>
                  <br><br>
                  전화번호: <b style="font-weight: 600;">${requestVO.event_requestphone }</b>
                  <br><br>
                   주소: <b style="color: #4caf50">${requestVO.event_requestaddr }</b>
                  <br><br>
